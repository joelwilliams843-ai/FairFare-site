...
- **Safari:** `Cmd + Shift + N`
- Open: https://price-shuttle.preview.emergentagent.com

#### 4. Check Network Connection
- Open: https://price-shuttle.preview.emergentagent.com/api/
...
```bash
curl https://price-shuttle.preview.emergentagent.com/api/
```
...
1. **Try the URL directly:**
   https://price-shuttle.preview.emergentagent.com

2. **Test the API:**
   https://price-shuttle.preview.emergentagent.com/api/
